    ...
    () => [
      ...
      // ----------------------------------------------------------------------
      {
        ...
        items: [
          ...
          {
            title: t('quatations'),
            path: paths.dashboard.quatation.list,
            icon: ICONS.file,
            ...
            children: [
              ...
              {
                title: t('create'), 
                path: paths.dashboard.quatation.new,
                roles: ['user'],
              },
            ],
          },
          {
            ...
            roles: ['admin','staff'],
            children: [
              // { title: t('profile'),roles: ['admin','staff'],
              //   path: paths.dashboard.user.root },
              // { title: t('cards'), roles: ['admin','staff'],
              //   caption: t('only_admin_can_see_this_item'),
              //   path: paths.dashboard.user.cards },
              { title: t('list'), roles: ['admin','staff'],
                path: paths.dashboard.user.list },
              { title: t('create'), roles: ['admin','staff'],
                path: paths.dashboard.user.new },
              // { title: t('edit'), roles: ['admin','staff'],
              //   path: paths.dashboard.user.demo.edit },
              // { title: t('account'), roles: ['admin','staff'],
              //   caption: t('only_admin_can_see_this_item'),
